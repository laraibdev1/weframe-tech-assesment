      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-gray-500 mt-2">Selon vos besoins</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-lg font-medium text-gray-800">Nettoyage</h3>
            <p className="text-sm text-gray-500 mt-2">Selon vos besoins</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-gray-500 mt-2">Tout est possible</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-gray-500 mt-2">On s’occupe de tout.</p>
          </div>
        </div>
      </div>
    </section>
